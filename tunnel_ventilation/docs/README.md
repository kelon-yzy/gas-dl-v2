...
4. [active/tv3_ec_msw_gatednet_implementation_plan.md](active/tv3_ec_msw_gatednet_implementation_plan.md)：P1 算法实验线；E1d 正式 `minimal_deployable_set_found`，下一步 E1d-SB（`cal_plus_corr_psr_snr` builder），E2 仍禁止。
