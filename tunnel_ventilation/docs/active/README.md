...
| 优先级 | 文档 | 当前状态 |
| --- | --- | --- |
| P1 | [tv3_ec_msw_gatednet_implementation_plan.md](tv3_ec_msw_gatednet_implementation_plan.md) | E1d-SB 正式 `parity_passed`；E1r attachment 代码已落地，正式待跑；`e2_allowed=false` |
| P1 | [tv3_ec_msw_structured_sequence_head_plan.md](tv3_ec_msw_structured_sequence_head_plan.md) | E1d-SB 过门；下一步 attachment；纯 TOF-L LS 仍禁止 |
