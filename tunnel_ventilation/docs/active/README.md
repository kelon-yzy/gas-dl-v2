...
| 优先级 | 文档 | 当前状态 |
| --- | --- | --- |
| ▶️ | [tv3_mrs_ei_mei3_execution_plan.md](tv3_mrs_ei_mei3_execution_plan.md) | **当前执行入口**：pre-B4=`mei3_pre_b4_technical_ready`；技术门已通过，B4 仅差独立数据授权 |
| ▶️ | [tv3_mrs_information_efficient_inversion_experiment_plan.md](tv3_mrs_information_efficient_inversion_experiment_plan.md) | **MRS-EI 上位主线**：MEI-3 Phase A、B0--B3 与 pre-B4 已通过；B4 正式数据与求解门仍未授权 |
