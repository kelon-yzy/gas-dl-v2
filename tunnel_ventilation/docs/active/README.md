...
| 优先级 | 文档 | 当前状态 |
| --- | --- | --- |
| P0 | [d2b_raw_dsp_implementation_plan.md](d2b_raw_dsp_implementation_plan.md) | clean 6000 构建契约、Ridge parity 与帧级 fidelity 均通过 |
| P0 | [d2b_raw_dsp_mlp_implementation_plan.md](d2b_raw_dsp_mlp_implementation_plan.md) | B6 配置与 provenance 已就绪，待服务器正式训练 |
