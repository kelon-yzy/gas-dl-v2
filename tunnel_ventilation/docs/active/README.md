...
| 📝  | [tv3_bidirectional_ultrasound_implementation_plan.md](tv3_bidirectional_ultrasound_implementation_plan.md)     | 双向超声 F 线：F4 `coarse_monitoring_only`（flow 解阻断，P90 未达 0.4）；下一步 F5 五臂对照                       |
