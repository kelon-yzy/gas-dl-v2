...
| 优先级 | 文档 | 当前状态 |
| --- | --- | --- |
| P1 | [tv3_ec_msw_gatednet_implementation_plan.md](tv3_ec_msw_gatednet_implementation_plan.md) | attachment 过门；E2s-LS 代码已落地，正式待跑；`e2_allowed=false` |
| P1 | [tv3_ec_msw_structured_sequence_head_plan.md](tv3_ec_msw_structured_sequence_head_plan.md) | SNR 加权 LS 消融入口；不得删 SNR |
