...
- Attachment 正式：`outputs/tv3_ec_msw/e1r_attach_e1d_sb_s20260704/` → `attachment_passed`；`e2_allowed=false`。
- Frame：peak MAE ≈ `0.037` sample（与正式 E1r 同档）；序列 O₂/Δ 与 E1d-SB 一致。
