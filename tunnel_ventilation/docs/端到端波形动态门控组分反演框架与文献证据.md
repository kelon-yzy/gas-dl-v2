...
- 当前问题已从“绝对峰位坐标丢失”收敛为“单一峰位坐标加 learned embedding 与固定 `last/mean/max` 聚合不具备 B1 信息充分性”。E1d / E1d-SB / attachment 均已正式过门。E2s-LS 正式过门但对 e1d_sb 几乎无增益，不晋升。下一步是 e1d_sb（无 LS）可部署联合系统计划；E2 FiLM/attention 仍禁止；B7 仍为默认头。
