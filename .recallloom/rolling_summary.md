...
<!-- file-state: revision=41 | updated-at=2026-06-04T09:14:50+08:00 | writer-id=Codex | base-workspace-revision=81 -->

<!-- section: current_state -->
- 2026-06-04：正式 HITRAN 标准数据集方案已由 512 条组分调整为 6000 条组分，每条保持 512 timesteps；正式数据集尚未生成。
