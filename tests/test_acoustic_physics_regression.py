...
_ATTEN_CASE_1_EXPECTED = {
    ...
    "alpha_n2_background_v2": 0.012261537952833865,
    "alpha_true_v2": 0.41764898506024956,
    "c_mix_used": 486.3,
...
_ATTEN_CASE_2_EXPECTED = {
    ...
    "alpha_n2_background_v2": 0.015531220059056073,
    "alpha_true_v2": 0.8483355874627274,
...
_ATTEN_CASE_3_EXPECTED = {
    ...
    "alpha_n2_background_v2": 0.005914022255161195,
    "alpha_true_v2": 0.4966857299991197,
...
_FEAT_1_EXPECTED = {
    "A_fft_max": 806.2730716477901,
    "Amp": 0.8820985501390792,
...
_FEAT_2_EXPECTED = {
    "A_fft_max": 833.0154134216292,
    "Amp": 0.9201997784398591,
...
_FEAT_3_EXPECTED = {
    "A_fft_max": 726.2572386704833,
    "Amp": 0.8241286789909228,
