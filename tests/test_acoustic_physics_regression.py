...
_SOUND_SPEED_CASES = [
    ...
    ((10.0, 50.0, 10.0, 30.0, 25.0), 396.63206477767915),
    ((0.0, 60.0, 15.0, 25.0, 30.0), 378.5116513732312),
    ((20.0, 40.0, 20.0, 20.0, 20.0), 391.22923152250434),
    ((5.0, 70.0, 5.0, 20.0, 35.0), 420.8116602069213),
...
_ATTEN_CASE_1_EXPECTED = {
    "alpha_ch4_v2": 0.15410095283861713,
    "alpha_classical_v2": 0.000346343507339856,
    "alpha_co2_v2": 0.3423799054511796,
    "alpha_h2_diffusion_v2": 3.6924873178486107e-09,
    "alpha_h2o_v2": 0.00012923756028473298,
    "alpha_n2_background_v2": 0.015033544778598218,
    "alpha_true_v2": 0.5119899878285068,
    "c_mix_used": 396.63206477767915,
...
_ATTEN_CASE_2_EXPECTED = {
    "alpha_ch4_v2": 0.21362754646273308,
    "alpha_classical_v2": 0.00043654442174454616,
    "alpha_co2_v2": 0.6635653132977484,
    "alpha_h2_diffusion_v2": 0.0,
    "alpha_h2o_v2": 0.00033991513794634547,
    "alpha_n2_background_v2": 0.01637395663272477,
    "alpha_true_v2": 0.8943432759528972,
    "c_mix_used": 378.5116513732312,
...
_ATTEN_CASE_3_EXPECTED = {
    "alpha_ch4_v2": 0.12019456046939778,
    "alpha_classical_v2": 0.00028618927008979965,
    "alpha_co2_v2": 0.5828287015374795,
    "alpha_h2_diffusion_v2": 5.7001306787321955e-09,
    "alpha_h2o_v2": 5.374633520310411e-05,
    "alpha_n2_background_v2": 0.008477341194029929,
    "alpha_true_v2": 0.7118405445063307,
    "c_mix_used": 391.22923152250434,
...
_FEAT_1_EXPECTED = {
    "A_fft_max": 783.7700559432259,
    "Amp": 0.8574792515109041,
    "TOF": 0.000835936229294158,
    "V_NDIR_CH4": 1.5586492732964947,
    "V_NDIR_CO2": 1.517607833837499,
    "V_TCS": 1.3009770880592428,
...
_FEAT_2_EXPECTED = {
    "A_fft_max": 825.2304397987318,
    "Amp": 0.9116000203951369,
    "TOF": 0.0006801819576977501,
    "V_NDIR_CH4": 1.3283303226746737,
    "V_NDIR_CO2": 1.8917630965233587,
    "V_TCS": 1.3007067708640914,
...
_FEAT_3_EXPECTED = {
    "A_fft_max": 719.3386205467152,
    "Amp": 0.816277698221049,
    "TOF": 0.0011978655317938752,
    "V_NDIR_CH4": 1.6635456975018763,
    "V_NDIR_CO2": 1.2398854570782656,
    "V_TCS": 1.1358912226092628,
