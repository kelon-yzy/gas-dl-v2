...
from sg.sim.core.syngas_schema import COMPONENT_FIELDS as SG_COMPONENT_FIELDS
...
class TestTrainerCompositionScheme:
    def test_trainer_rejects_target_transform_on_syngas(self):
        ...
        from sg.common.composition import TargetTransformSpec
        from sg.dl.training.trainer import Trainer
