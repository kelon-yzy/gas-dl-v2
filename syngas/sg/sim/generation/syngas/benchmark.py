...
from sg.sim.core.ids import BenchmarkDatasetId
from sg.sim.core.schema import MULTI_PATH_PHASES, SPLIT_NAMES, VALID_STORAGE_FORMATS
...
from sg.sim.generation.phases import PHASE_SCHEDULES, PhaseSchedule, resolve_phase_schedule
...
from sg.sim.packaging.arrays import write_arrays
from sg.sim.packaging.index import build_sequence_index_rows
from sg.sim.packaging.io import write_csv, write_json
from sg.sim.packaging.manifest import build_manifest
from sg.sim.packaging.scalers import fit_z_score_scalers
from sg.sim.packaging.splits import build_default_split_rows
from sg.sim.validation.integrity import validate_benchmark_assets
...
def _build_sequence_arrays_for_spec(
    *,
    ...
    from sg.sim.generation.syngas._parallel import build_arrays_parallel
...
def _cleanup_parallel_temp_arrays(arrays: dict[str, object]) -> None:
    from sg.sim.generation.syngas._parallel import cleanup_parallel_temp_arrays
