...
from sim.core.syngas_schema import SLOW_CHANNELS, SLOW_DYNAMIC_CHANNELS
...
from sim.generation.syngas.optical_backend import compute_hitran_syngas_optical_absorption
