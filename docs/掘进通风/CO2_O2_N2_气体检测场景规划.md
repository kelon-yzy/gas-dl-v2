...
> 实施状态（2026-07-05）：阶段 1–3 仿真链路 + 阶段 4 DL/ML 适配 + tv3-formal（600 序列）+ Ridge/TCN 首轮基线已落地。完整 15 runs 基线矩阵与后续 ablation 待决策。详见 [adaptation_plan.md](adaptation_plan.md) §实施进度。
